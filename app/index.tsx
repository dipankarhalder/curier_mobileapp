...
import { sp_banner_1, sp_banner_2, sp_banner_3 } from "../constant/static";
      ...
      >
        {slides.map((slide) => (
          <View
            ...
            className="flex-col justify-start pt-10"
          >
            <View className="flex-col w-full h-[auto]">
              <Image
                source={slide.img}
                resizeMode="contain"
                style={{ width: "auto", height: height * 0.65 }}
              />
            </View>
